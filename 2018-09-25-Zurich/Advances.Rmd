...
- We started work on the `lme4` package around 2000.  Initially it incorportated both the modeling code and the sparse matrices, etc. Eventually we split off the code for dense and sparse matrices using S4 classes into the `Matrix` package.
